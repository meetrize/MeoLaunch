...
/**
 * Last known screen for each window chip (windowID → NSScreenNumber).
 * Peek / Show Desktop parks windows off-screen; never re-home chips from those
 * transient bounds or they jump across taskbars.
 */
...
/**
 * User clicked exposed desktop while windows are minimized — allow peek even though
 * chips are all hidden (unlike passive minimize-all, which must stay normal).
 */
